namespace SilentMike.Gielda.Commision.Application.Common.Behaviors;

using FluentValidation.Results;
using ValidationException = SilentMike.Gielda.Commision.Application.Common.Exceptions.ValidationException;
