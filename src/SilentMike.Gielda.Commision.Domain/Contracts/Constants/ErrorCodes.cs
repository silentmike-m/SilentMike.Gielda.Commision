namespace SilentMike.Gielda.Commision.Domain.Contracts.Constants;
...
internal static class ErrorCodes
{
    ...
    public static readonly string CONTRACT_ITEM_INVALID_PRICE = nameof(CONTRACT_ITEM_INVALID_PRICE);
}
